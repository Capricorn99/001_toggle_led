...
int main(void)
{
    ...
    ui32Period = 20000000;     //Thiet lap gia tri cua chu ky dua tren tan so he thong
...
//Chuong trinh ngat
/*
 * Luu ý phải vào file ..._ccs.c
 *
 * thêm extern void [Timer0IntHandler(void)]
 * thêm [Timer0IntHandler] vào chỗ timer 0
 */
